...
fname = "/home/Storage/MG5_Study_Group/Cards/Scan_rinv_alpha_v2/SVJ_" + str(rinv) + "_" + str(lambdas) + ".cmnd"
...
f.write('Beams:LHEF = /home/Storage/MG5_Study_Group/sig_schannel_up2jets_wz_auto/Events/run_01/unweighted_events.lhe \n') 
f.close()